...
<td><?= $statusy[$naprawa['IDStatus']];?></td>
    ...
    <td><a href="http://<?php echo $_SERVER['HTTP_HOST']?>/<?php echo \Config\Website\Config::$subdir?>Naprawa/editform<?= $naprawa['IDNaprawa']; ?>">edytuj</a></td>
<td><a href="http://<?php echo $_SERVER['HTTP_HOST']?>/<?php echo \Config\Website\Config::$subdir?>Naprawa/delete<?= $naprawa['IDNaprawa']; ?>">usuń</a></td>
                </tr>
    <?php }
